...
class JobpageWindow(Tk.Frame):
    ...
    def generate_jobpage(self, job):
        ...
        Tk.Label(self.basic_information_window, text="Tests: " + str(job[3])).grid(row=2, column=0, sticky=Tk.W)
        Tk.Label(self.basic_information_window, text="Receive Date: " + str(job[2])).grid(row=3, column=0, sticky=Tk.W)
        Tk.Label(self.basic_information_window, text="Status: " + str(job[4])).grid(row=4, column=0, sticky=Tk.W)
